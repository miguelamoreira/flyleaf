    ...
    <v-app>
      ...
      <v-container fluid class="fill-height fill-width justify-center" style="background-color: var(--vt-c-beige)">
        <v-row justify="center" class="justify-center">
          <v-col cols="12">
        <v-card class="pa-6 pt-8 rounded-lg" elevation="4" style="z-index: 1; background-color: var(--vt-c-brown-light); width: 65vh;">
          ...
          <v-card-text>
            ...
            <p class="text-center pt-8">Have an account already? <routerLink style="color: var(--vt-c-green-light);" :to="{ name: 'signup' }">Click here</routerLink></p>
          </v-card-text>
        </v-card>
        </v-col>
        </v-row>
